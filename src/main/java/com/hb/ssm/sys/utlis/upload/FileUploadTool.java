package com.hb.ssm.sys.utlis.upload;
...
public class FileUploadTool {
     ...
     * 最大上传不超过20M
     */
    private static long upload_maxsize = 20 * 1024 * 1024;
    // 文件最大500M
     ...
     */
    private static String[] allowFiles = {".txt", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx"//文本文件类型
            , ".wmv", ".mp4", ".avi", ".3gp", ".mov", ".m4v" //视频文件类型
            , ".wma", ".mp3" //音频文件类型
            , ".jpeg", ".bmp", ".jpg", ".gif", ".png" //图片文件类型

    };
    // 允许转码的视频格式（ffmpeg）mp4,m4v
    private static String[] allowFLV = {".wmv", ".avi",  ".3gp", ".mov", ".mpg"
            , ".asf", ".asx", ".vob" };
    // 允许的视频转码格式(mencoder)
